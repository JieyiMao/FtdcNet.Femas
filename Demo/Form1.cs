...
namespace Demo
{
    public partial class Form1 : Form
    {
        ...
        string TD_FRONT_ADDR = "tcp://118.126.16.227:17196";
        string MD_FRONT_ADDR = "tcp://118.126.16.227:17101";
        string BrokerID = "0228";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (DataApi != null)
            {
                DataApi.UnSubscribeMarketData(new string[] { "IF1701", "IF1612" });
            }
        }
