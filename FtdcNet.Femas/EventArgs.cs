...
namespace Femas
{
    ...
    public class OnPackageEventArgs : EventArgs
    {
        public EnumOnPackageType EventType { get; protected set; }
        public int TopicID { get; protected set; }
        public int SequenceNo { get; protected set; }
        public OnPackageEventArgs(EnumOnPackageType EventType, int nTopicID, int nSequenceNo)
        {
            this.EventType = EventType;
            this.TopicID = nTopicID;
            this.SequenceNo = nSequenceNo;
        }
    }
    ...
    public delegate void OnPackageEventHandler(object sender, OnPackageEventArgs e);
